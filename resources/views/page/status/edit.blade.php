                    ...
                    <div class="card mb-4">
                        <div class="card card-header-actions">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="small mb-1" for="inputID">ID Status</label>
                                    <input class="form-control" id="inputID" name="inputID" type="text"
                                        value="{{ $status->id_status }}" placeholder="Masukkan ID status..." />
                                </div>
                                <div class="mb-3">
                                    <label class="small mb-1" for="inputNama">Nama Status</label>
                                    <input class="form-control" id="inputNama" name="inputNama" type="text"
                                        value="{{ $status->nama_status }}" placeholder="Masukkan nama status..." />
                                </div>
                            </div>
                        </div>
                    </div>
