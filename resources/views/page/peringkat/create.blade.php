...
@section('content')
    ...
    <div class="container-fluid px-4 mt-4">
        <form method="POST" action="{{ route('peringkat.store') }}">
            @csrf
            @if ($errors->any())
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputNamaPeringkat" name="inputNamaPeringkat"
                                        type="text" placeholder="Masukkan nama peringkat..." />
                                </div>
                                <div class="mb-3">
                                    <label class="small mb-1" for="orderPeringkat">Order</label>
                                    <input class="form-control" id="orderPeringkat" name="orderPeringkat" type="text"
