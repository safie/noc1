...
@section('button')
    <a class="btn btn-sm btn-light text-primary" href="{{ route('kementerian.index') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputNamaKementerian" name="inputNamaKementerian"
                                        type="text" placeholder="Masukkan nama kementerian/jabatan..." />
                                </div>
                                <div class="mb-3">
                                    <label class="small mb-1" for="inputFirstName">Singkatan Kementerian</label>
