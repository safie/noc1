                    ...
                    <div class="card mb-4">
                        <div class="card card-header-actions">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="small mb-1" for="inputFirstName">Nama Bahagian</label>
                                    <input class="form-control" id="inputNamaBahagian" name="inputNamaBahagian"
                                        value="{{ $bahagian->nama_bhgn }}" type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputSingkatan" name="inputSingkatan" type="text"
                                        value="{{ $bahagian->sgktn_bhgn }}"
                                        placeholder="Masukkan singkatan bahagian..." />
                                </div>
                            </div>
                        </div>
                    </div>
