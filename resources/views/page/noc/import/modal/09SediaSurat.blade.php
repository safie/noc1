<form method="POST" action="{{ route('noc.updateSediaSurat', $noc->id) }}">
    ...
    <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Proses: Penyediaan Surat Kelulusan</h5>
        <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
        <div class="mb-3">
            <label class="small mb-1" for="inputFirstName">Tarikh Penyediaan Surat</label>
