@if (Auth::user()->peranan == 3)
    <form method="POST" action="{{ route('noc.updateHantarUlasanBajet', $noc->id) }}">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Proses: Penghantaran Ulasan Bajet</h5>
...
@if (Auth::user()->peranan == 4)
    <form method="POST" action="{{ route('noc.updateHantarUlasanTeknikal', $noc->id) }}">
        ...
        @method('PUT')
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Proses: Penghantaran Ulasan Teknikal</h5>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="mb-3">
