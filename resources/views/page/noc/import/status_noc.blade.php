            ...
            <ol class="list-group list-group-flush">
                ...
                @if ($noc->tarikh_submit != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">NOC Baharu</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_semak != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Mohon Ulasan</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->status_noc == 'noc_11')
                    <li class="list-group-item d-flex justify-content-start">
                        <div class="ms-3">
                            {{ \Carbon\Carbon::parse($noc->tarikh_semak)->format('d-m-Y') }}</div>
                        <div class="ms-1 w-50"><span class="badge bg-danger">Semakan semula</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_mohon_ulasan != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Permohonan Ulasan
                                Disemak</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_sedia_ulasan != null && $noc->status_noc == 'noc_12')
                    <li class="list-group-item d-flex justify-content-start">
                        <div class="ms-3 ">
                            {{ \Carbon\Carbon::parse($noc->tarikh_semak)->format('d-m-Y') }}</div>
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Perlu maklumat tambahan</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_sedia_ulasan != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Penyediaan Ulasan</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_hantar_ulasan != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Penghantaran Ulasan NOC</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_sedia_memo_kelulusan != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Penyediaan Memo
                                Kelulusan</span></div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_kelulusan_pt != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Terima Memo Kelulusan
                ...
                @if ($noc->tarikh_sedia_surat != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Penyediaan Surat
                                Kelulusan</span></div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_hantar_surat_lulus != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Terima Surat Kelulusan
                                Rasmi</span></div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_mohon_modul != null)
                    <li class="list-group-item d-flex justify-content-start">
                        ...
                        <div class="ms-1 w-50"><span class="badge bg-secondary">Modul NOC MyProjek</span>
                        </div>
                    </li>
                @endif
            </ol>
