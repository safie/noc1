            ...
            <ol class="list-group list-group-flush">
                ...
                @if ($noc->tarikh_mohon_ulasan != null)
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <div class="ms-1 flex-grow-1"><span class="badge bg-secondary">Permohonan Ulasan Disemak</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_hantar_ulasan != null)
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <div class="ms-1 flex-grow-1"><span class="badge bg-secondary">Penghantaran Ulasan NOC</span>
                        </div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_hantar_surat_lulus != null)
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <div class="ms-1 flex-grow-1"><span class="badge bg-secondary">Terima Surat Kelulusan
                                Rasmi</span></div>
                    </li>
                @endif
                ...
                @if ($noc->tarikh_mohon_modul != null)
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <div class="ms-1 flex-grow-1"><span class="badge bg-secondary">Permohonan NOC MyProjek</span>
                        </div>
                    </li>
                @endif
            </ol>
