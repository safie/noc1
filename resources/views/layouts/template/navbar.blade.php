<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white d-print-none"
    id="sidenavAccordion">
    ...
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('home') }}">Sistem Pemantauan NOC</a>
    <!-- Navbar Search Input-->
            ...
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                ...
                <h6 class="dropdown-header d-flex align-items-center">
                    <img class="dropdown-user-img"
                        src="{{ asset('sb-admin-pro/dist/assets/img/illustrations/profiles/profile-2.png') }}" />
                ...
                <a class="dropdown-item" href="{{ route('pengguna.show', Auth::user()->id) }}">
